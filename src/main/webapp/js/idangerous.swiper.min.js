...
var Swiper = function (a, b) {
  ...
  function A() {
    C.calcSlides(),
      b.lo.slides.length > 0 && 0 === C.slides.length && C.loadSlides(),
      b.loop && C.createLoop(),
      C.init(),
      f(),
  ...
  if (
    ...
    (C.startAutoplay = function () {
      ...
      (C.loadSlides = function () {
        ...
        for (
          var c = b.lo.slides,
            d = b.lo.loadAllSlides
              ? c.length
              : b.slidesPerView * (1 + b.lo.surroundGroups),
            e = 0;
          d > e;
          e++
        )
          a +=
            "outer" === b.lo.slidesHTMLType
              ? c[e]
              : "<" +
                b.slideElement +
                ' class="' +
        ...
        (C.wrapper.innerHTML = a),
          C.calcSlides(!0),
          b.lo.loadAllSlides || C.wrapperTransitionEnd(C.reloadSlides, !0);
      }),
      (C.reloadSlides = function () {
        ...
        if (!(0 > c || c > a.length - 1)) {
          C.activeloIndex = c;
          var d = Math.max(0, c - b.slidesPerView * b.lo.surroundGroups),
            e = Math.min(
              c + b.slidesPerView * (1 + b.lo.surroundGroups) - 1,
              a.length - 1
            );
          if (c > 0) {
            var f = -E * (c - d);
